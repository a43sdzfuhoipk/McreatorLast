package net.mcreator.endredefined.world.features.treedecorators;
...
@EventBusSubscriber
public class BiomeFruitDecorator extends CocoaDecorator {
	public static MapCodec<BiomeFruitDecorator> CODEC = MapCodec.unit(BiomeFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("end_redefined:biome_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public BiomeFruitDecorator() {
		super(0.2f);
	}
