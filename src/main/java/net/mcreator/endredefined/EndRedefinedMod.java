package net.mcreator.endredefined;
...
import net.mcreator.endredefined.init.EndRedefinedModVillagerProfessions;
import net.mcreator.endredefined.init.EndRedefinedModTabs;
...
@Mod("end_redefined")
public class EndRedefinedMod {
	public static final Logger LOGGER = LogManager.getLogger(EndRedefinedMod.class);
	public static final String MODID = "end_redefined";

	public EndRedefinedMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		EndRedefinedModBlocks.REGISTRY.register(modEventBus);
		EndRedefinedModItems.REGISTRY.register(modEventBus);
		EndRedefinedModTabs.REGISTRY.register(modEventBus);
		EndRedefinedModVariables.ATTACHMENT_TYPES.register(modEventBus);
		EndRedefinedModMobEffects.REGISTRY.register(modEventBus);
		EndRedefinedModVillagerProfessions.PROFESSIONS.register(modEventBus);
